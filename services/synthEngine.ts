...
export class SynthEngine {
  ...
  public recordedBuffer: AudioBuffer | null = null;
  ...
  public async stopRecording(): Promise<AudioBuffer | null> {
      return new Promise((resolve) => {
          if (!this.mediaRecorder) return resolve(null);
          
          this.mediaRecorder.onstop = async () => {
              // Decode buffer for waveform visualization
